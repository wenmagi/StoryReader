...
abstract class BaseReadActivity : Activity() {
    ...
    private fun cacheDialog() {
        if (cacheWindown == null) {
            ...
            dialogView.findViewById(R.id.tvCacheBehind50).setOnClickListener {
                isInBookCase()
            ...
            dialogView.findViewById(R.id.tvCacheBehindAll).setOnClickListener {
                isInBookCase()
                var event = DownloadBookEvent()
                event.bean = mBookCaseBean
            ...
            dialogView.findViewById(R.id.tvCacheAll).setOnClickListener {
                isInBookCase()
                var event = DownloadBookEvent()
                event.bean = mBookCaseBean
